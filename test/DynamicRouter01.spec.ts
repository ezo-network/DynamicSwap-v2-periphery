...
enum RouterVersion {
  DynamicRouter01 = 'DynamicRouter01',
  DynamicRouter02 = 'DynamicRouter02'
}

describe('DynamicRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.DynamicRouter01]: fixture.router01,
        [RouterVersion.DynamicRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DynamicRouter01]: 101876,
              [RouterVersion.DynamicRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DynamicRouter01]: 138770,
              [RouterVersion.DynamicRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
